                ...
                @foreach ($produit->recommandations as $produit_recommande)
                    <div class="max-w-sm border border-double shadow-lg rounded-lg bg-white">
                        ...
                        <div class="mt-4 px-4">
                            ...
                            <span class="text-md text-cyan-700 font-bold hover:text-blue-700"><a href="{{ route('voir_produit_par_categorie', $produit_recommande->category->id) }}">{{ $produit_recommande->category->nom }}</a></span><br>
                            <div class="mt-3 flex justify-between mb-3">
