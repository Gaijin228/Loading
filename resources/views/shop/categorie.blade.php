        ...
        <div class="mx-14 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            {{-- @foreach($produits as $produit) --}}
                ...
                <div class="max-w-sm border border-double shadow-lg rounded-lg bg-white">
                    <img src="../dist/img/3.jpg" alt="3" class="rounded-t-lg">
                    <div class="mt-4 px-4">
                        <h5 class="text-xl text-gray-600 font-bold">I'm The Queen</h5>
                        <span>description du t-shirt</span><br>
                        <div class="mt-3 flex justify-between mb-3">
                            <span class="text-lg text-blue-700 font-bold">20.00 €</span>
                            <a href="produit.html" target="_blank" class="bg-yellow-400 hover:bg-cyan-700 rounded-md px-1">
